 ...
 * prior state.
 */
class K8sLogicalTableCrdDeployer extends K8sDeployer<V1alpha1LogicalTable, V1alpha1LogicalTableList> {
  ...
  K8sLogicalTableCrdDeployer(String crdName, String databaseLabel, String tableName,

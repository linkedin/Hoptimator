...
public final class LogicalTable extends AbstractTable {
  ...
  public LogicalTable(String name, Map<String, V1alpha1LogicalTableSpecTiers> tiers,
    ...
    this(name, tiers, resolvedTier, new K8sApi<>(context, K8sApiEndpoints.DATABASES));
  }

  /** Package-private constructor for testing — accepts an injectable database API. */
  LogicalTable(String name, Map<String, V1alpha1LogicalTableSpecTiers> tiers,
      @Nullable String resolvedTier, K8sApi<V1alpha1Database, V1alpha1DatabaseList> databaseApi) {
  ...
  private RelDataType resolveRowType() {
    ...
    if (resolvedTier != null) {
      ...
      // Not strictly needed but helps for debugging consistency

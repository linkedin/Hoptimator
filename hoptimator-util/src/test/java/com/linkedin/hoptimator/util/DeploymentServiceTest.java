...
class DeploymentServiceTest {
  ...
  void testDeployersReturnsEmptyWithNoProviders() {
    ...
    com.linkedin.hoptimator.Deployable deployable = new com.linkedin.hoptimator.Deployable() { };
  ...
  void testSpecifyDelegatesToDeployersAndCollectsSpecs() throws SQLException {
    ...
    try (MockedStatic<DeploymentService> mocked = Mockito.mockStatic(DeploymentService.class,
        Mockito.CALLS_REAL_METHODS)) {
      mocked.when(DeploymentService::providers).thenReturn(Collections.singletonList(provider));
  ...
  void testPlanCreatesImplementor() throws SQLException {
    ...
    RelRoot root = RelRoot.of(values, values.getRowType(), org.apache.calcite.sql.SqlKind.SELECT);

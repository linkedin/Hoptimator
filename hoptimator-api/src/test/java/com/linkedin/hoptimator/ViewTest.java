...
class ViewTest {
  ...
  void testTableReturnsLastPathElement() {
    View view = new View(null, List.of("schema", "myView"), "SELECT 1");
    assertEquals("myView", view.table());
  }

  @Test
  void testSchemaReturnsPenultimateElement() {
    View view = new View(null, List.of("catalog", "schema", "myView"), "SELECT 1");
    assertEquals("schema", view.schema());
  }

  @Test
  void testSchemaReturnsNullForSingleElementPath() {
    View view = new View(null, List.of("myView"), "SELECT 1");
  ...
  @Test
  void testViewSql() {
    View view = new View(null, List.of("v"), "SELECT * FROM t");
  ...
  void testPath() {
    ...
    View view = new View(null, path, "SELECT 1");
    assertEquals(path, view.path());
  }

  @Test
  void testToString() {
    View view = new View(null, List.of("s", "v"), "SELECT 1");

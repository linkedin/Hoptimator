...
public abstract class GraphNode {
  ...
  public static final class Trigger extends GraphNode {
    ...
    public Trigger(String name, @Nullable String schedule, boolean paused,
       @Nullable String jobTemplateName, @Nullable String containerName) {
    ...
    public @Nullable String jobTemplateName() {
      return jobTemplateName;
    }

    /** First container's name in the rendered job spec. */
  ...
  public static final class External extends GraphNode {
    ...
    public External(String database, List<String> path) {

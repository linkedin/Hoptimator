 ...
 * internal implementation. Same pattern {@link GraphNode} uses for its kinds.
 */
public abstract class GraphTarget {
  ...
  /** A regular or materialized view, identified by its canonical name. */
  ...
  /** A logical table identified by its canonical name. */

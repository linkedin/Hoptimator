...
| Field        | Type   | Description                                                                                       |
| ------------ | ------ | ------------------------------------------------------------------------------------------------- |
| `yaml`       | string | YAML template used to generate K8s specs. Placeholders are `{{var}}` ([syntax](templates.md)).    |
...
See [Templates](templates.md) for placeholder syntax and full examples.
...
| Field       | Type   | Description                                                                          |
| ----------- | ------ | ------------------------------------------------------------------------------------ |
| `yaml`      | string | YAML template. Has access to `{{flinksql}}`, `{{flinkconfigs}}`, plus everything in [TableTemplate's environment](templates.md#default-placeholders). |
| `databases` | array  | Database names this template matches. If null/empty, matches every database.         |

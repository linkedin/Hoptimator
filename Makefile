...
deploy-venice: deploy deploy-flink
	...
	docker exec venice-client ./create-store.sh http://venice-controller:5555 venice-cluster0 test-store sample-data/schema/keySchema.avsc sample-data/schema/valueSchema.avsc
	docker exec venice-client ./create-store.sh http://venice-controller:5555 venice-cluster0 test-store-1 sample-data/schema/keySchema.avsc sample-data/schema/valueSchema.avsc
